/*
    DSA PROJECT      SECTION 4
        GROUP MEMBERS       ID
    1. NEBIL RAHMETO    UGR/25275/14
    2. TESFAHUN ABERA   UGR/26813/14
    3. SAMUEL TADESSE   UGR/25633/14
    4. TEMESGEN ERGAMO  UGR/26450/14
    5. DANIEL TADESSE   UGR/25670/14
    6. NATNAEL CHALA    UGR/25371/14
 */
/*
    War is a simple card game that is typically played by two players using a standard
    playing card deck. The objective of the game is to win all cards. Each player receives
    26 cards - dealing one at a time. To start, both players play a card at the same time.
    The person with the highest card rank will collect both cards. Howeveer, if the players
    have equally valued cards, they will go to war. Meaning they will deal 5 cards (user input
    in this case) before comparing the last one. and winner takes all the played cards.
    A player wins when he has collected all the cards.
*/
